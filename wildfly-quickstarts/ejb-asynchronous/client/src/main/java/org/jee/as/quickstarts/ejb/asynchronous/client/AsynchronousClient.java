 ...
 */
package org.jee.as.quickstarts.ejb.asynchronous.client;
...
public class AsynchronousClient {
     ...
     */
    private final org.jee.as.quickstarts.ejb.asynchronous.AsynchronousAccess accessBean;
    /**
     * Proxy of the SLSB that uses asynchronous bean calls inside to parallelize internal actions.
     */
    private final org.jee.as.quickstarts.ejb.asynchronous.ParallelAccess parallelBean;
    ...
    private AsynchronousClient() throws NamingException {
        ...
        String lookupName = "ejb:/ejb-asynchronous-ejb/AsynchronousAccessBean!" + org.jee.as.quickstarts.ejb.asynchronous.AsynchronousAccess.class.getName();
        LOGGER.info("Lookup Bean >" + lookupName);
        accessBean = (org.jee.as.quickstarts.ejb.asynchronous.AsynchronousAccess) context.lookup(lookupName);
        lookupName = "ejb:/ejb-asynchronous-ejb/ParallelAccessBean!" + org.jee.as.quickstarts.ejb.asynchronous.ParallelAccess.class.getName();
        LOGGER.info("Lookup Bean >" + lookupName);
        parallelBean = (org.jee.as.quickstarts.ejb.asynchronous.ParallelAccess) context.lookup(lookupName);
    }
