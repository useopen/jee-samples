 ...
 */
package org.jee.as.quickstarts.temperatureconverter.ejb;
...
public class TemperatureConvertEJB {
    ...
    public Temperature convert(Temperature source) {
        ...
        if (source.getScale() == Scale.CELSIUS) { // Celsius to Fahrenheit
            ...
            return new Temperature((source.getTemperature() * 9 / 5) + 32, Scale.FAHRENHEIT);
        } else if (source.getScale() == Scale.FAHRENHEIT) { // Fahrenheit to Celsius
            // Easter egg for Absolute Zero.
            ...
            return new Temperature((source.getTemperature() - 32) * 5 / 9, Scale.CELSIUS);
